...
const HeroSection: React.FC = () => {
  ...
  return <section ref={sectionRef} id="hero" className="relative min-h-[100dvh] flex flex-col items-center pt-20 bg-[#0E0E10] overflow-hidden">
      ...
      <div ref={textRef} className="relative z-10 max-w-[min(88%,640px)] px-6 sm:px-12 mb-10 sm:mb-0 flex flex-col items-start">
        ...
        <motion.p className="mt-6 text-lead font-medium gradient-text animate-gradient-x" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        <motion.div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-8 justify-start" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
