...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={textRef} 
        className="relative z-10 max-w-4xl ml-6 md:ml-16 mt-24 md:mt-28 flex flex-col items-start"
      >
        <motion.h1 
          className="text-4xl md:text-6xl font-bold text-white text-left leading-tight"
        ...
        <motion.p 
          className="mt-6 text-xl md:text-2xl font-medium gradient-text animate-gradient-x"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
